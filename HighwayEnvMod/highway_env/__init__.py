...
def register_highway_envs():
    ...
    # mark crowley's new environment with altered reward and actions and observation space : Spring 2025
    register(
        id='highway-better-v1',
        entry_point='highway_env.envs:HighwayEnvBetter',
    )
   # mark crowley: harder oponnent cars : Spring 2025
    register(
        id='highway-better-v1_1',
        entry_point='highway_env.envs:HighwayEnvBetterv1_1',
    )
    # intersection_env.py
    register(
        id='intersection-v0',
